...
<?php 
	...
	<section class="cart-view">
		<div class="row">
			...
			<div class="col-md-12">
				<?php echo anchor('cart/delete_all_item', '<i class="fa fa-trash"></i>&nbsp; Clear Cart', array('class' => 'btn btn-danger pull-right')) ?>
			</div>
			<?php } ?>
			<div class="col-md-12">
				<table class="table table-hover cart-table">
					...
					<?php 
						...
						{	
							...
							{ 
								?>
								<tr id="item-tr-<?php echo $value['p_id']; ?>">
									...
									<td class="col-sm-1 col-md-1">
										<button type="button" onclick="delete_items(<?php echo $value['p_id']; ?>)" class="btn btn-danger" data-toggle="tooltip" title="Remove">
								...
								<h5>
									<strong>
										<span id="shipping-date">
											<?php echo $this->cart->contents() == FALSE ? '' : date("M d, Y", strtotime("+2 Weeks")); ?>
										</span>
									</strong>
								</h5>
							</td>
